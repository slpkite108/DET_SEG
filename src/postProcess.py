...
def main():
    ...
    if mod=='.nii.gz':
        ...
        #label_path = "/home/oem/datas/jayeon/TrainedData/Paper/Segmenter/generation/amos_resize_filtered_Crop_patched_128_b4_2e-3/nrrd/inf_lab1_gen_14.nrrd"
        label_path = "/home/oem/datas/jayeon/TrainedData/Paper/Segmenter/generation/amos_resize_filtered_Crop_patched_128_b4_2e-3/nrrd/inf_lab1_gt_14.nrrd"
        
    #saveFolder = os.path.normpath(r'C:\Users\Nature\Desktop\nrrd')
    saveFolder = "/home/oem/datas/jayeon/TrainedData/Paper/Segmenter/generation/amos_resize_filtered_Crop_patched_128_b4_2e-3/"
    ...
    result_image = get_largest_connected_component(label,label_value, None)
    sitk.WriteImage(result_image, os.path.join(saveFolder,f'pp_gt_14.nrrd'))
